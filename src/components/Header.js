                ...
                <div className="container">
                    <nav className="navbar flex items-center" aria-label="Main Navigation">
                        ...
                        <div className="navbar__branding mr-2">
                            {logo ? <Link className="navbar__logo m-0" href={withPrefix('/')}>        <a href="https://wildfirewatcher.wordpress.com/blog/" target="_blank">
<img src={withPrefix(logo)} alt={logoAlt} /></Link></a>
